...
export const changelogData: ChangelogItem[] = [
  {
    ...
    version: 'v2.5.0',
    date: 'July 2026',
    title: 'Official AniSpin v2.5.0 Release',
    tag: 'Major Release',
    changes: {
      added: [
        'Upgraded codebase architecture to support dynamic GitHub Release configurations.',
        'Implemented remote site-config dashboard for real-time app distribution management.',
        'Added full dynamic Google Play and iOS App Store badge toggle support.'
      ],
      improved: [
        'Optimized server-side data fetching for instant app state sync.',
        'Enhanced cyberpunk neon UI responsiveness and custom themes.'
      ],
      fixed: [
        'Resolved static path caching in production deployment.'
      ]
    }
  },
  {
...
export const initialSiteConfig: SiteConfig = {
  ...
  heroBadgeText: 'v2.5.0 Official Release',
  version: '2.5.0',
  releaseDate: 'July 2026',
  apkSize: '70 MB',
  minAndroidVersion: 'Android 8.0 (Oreo) or higher',
  sha256Hash: 'e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855',
  primaryApkUrl: 'https://github.com/kunsahil42-cpu/AniSpin-v2/releases/download/v2.5.0/Anispinv2.5.apk',
  mirrors: [
  ...
  releaseNotes: 'Added Predictive Episode Broadcast alert card with local timezone conversion.\nAdded 5-Dot Anime Roll and Manga Roll random recommendation engine.\nAdded Cache Manager with automatic image cache cleaner in Settings.\nAdded full support for Android 15 & edge-to-edge navigation.',
  changelog: [] // Will be populated with changelogData at runtime below, or we can use changelogData
};

// Populate initial changelog reference
initialSiteConfig.changelog = changelogData;
...
// Old changelogData removed and moved to the top.
