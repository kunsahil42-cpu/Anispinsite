...
// Validate ../../src/app/api/admin/upload-apk/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/admin/upload-apk">> = Specific
  const handler = {} as typeof import("../../src/app/api/admin/upload-apk/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
